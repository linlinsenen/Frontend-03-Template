...
function getStyle(element) {
    ...
    function layout(element) {
        ...
        if (!style.justifyContent || sytle.justifyContent === 'auto') {
        ...
        flexLines.forEach(function (items) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (item === null) {
                    itemStyle[crossSize] = (align === 'stretch') ? linieCrossSize : 0;
                }
